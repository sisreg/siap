...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \Minsal\SiapsBundle\Entity\FosUserGroup $group
     * @return FosUserUser
     */
    public function addGroup(\Minsal\SiapsBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Minsal\SiapsBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\Minsal\SiapsBundle\Entity\FosUserGroup $group)
    {
