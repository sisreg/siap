...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \Minsal\LaboratorioBundle\Entity\FosUserGroup $group
     * @return FosUserUser
     */
    public function addGroup(\Minsal\LaboratorioBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Minsal\LaboratorioBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\Minsal\LaboratorioBundle\Entity\FosUserGroup $group)
    {
